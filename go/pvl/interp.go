...
const (
	...
	WhitespaceNormalize = "whitespace_normalize"
...
type PvlStep func(libkb.ProofContext, *jsonw.Wrapper, PvlScriptState) (PvlScriptState, libkb.ProofError)

var PvlSteps = map[string]PvlStep{
	PvlAssertRegexMatch: pvlStepAssertRegexMatch,
	PvlAssertFindBase64: pvlStepAssertFindBase64,
	WhitespaceNormalize: pvlStepWhitespaceNormalize,
...
func CheckProof(g libkb.ProofContext, pvl *jsonw.Wrapper, service keybase1.ProofType, link libkb.RemoteProofChainLink, h libkb.SigHint) libkb.ProofError {
...
func CheckProofInner(g libkb.ProofContext, pvl *jsonw.Wrapper, service keybase1.ProofType, link libkb.RemoteProofChainLink, h libkb.SigHint) libkb.ProofError {
...
func pvlValidateChunk(g libkb.ProofContext, pvl *jsonw.Wrapper, service keybase1.ProofType) libkb.ProofError {
	// Check the version.
...
func pvlValidateScript(g libkb.ProofContext, script *jsonw.Wrapper, service keybase1.ProofType, whichscript int) libkb.ProofError {
	// Scan the script.
	// Does not validate each instruction's format. (That is done when running it)

	logerr := func(g libkb.ProofContext, service keybase1.ProofType, whichscript int, pc int, format string, arg ...interface{}) libkb.ProofError {
	...
	for i := 0; i < scriptlen; i++ {
		...
		case pvlJSONHasKey(ins, WhitespaceNormalize):
...
func pvlRunDNS(g libkb.ProofContext, scripts []*jsonw.Wrapper, startstate PvlScriptState) []libkb.ProofError {
...
func pvlRunDNSOne(g libkb.ProofContext, scripts []*jsonw.Wrapper, startstate PvlScriptState, domain string) libkb.ProofError {
...
func pvlRunScript(g libkb.ProofContext, script *jsonw.Wrapper, startstate PvlScriptState) libkb.ProofError {
...
func pvlStepInstruction(g libkb.ProofContext, ins *jsonw.Wrapper, state PvlScriptState) (PvlScriptState, libkb.ProofError) {
	var name string
	var step PvlStep
	n := 0

	for iname, istep := range PvlSteps {
		if pvlJSONHasKey(ins, iname) {
			step = istep
			name = iname
			n++
		}
...
func pvlStepAssertRegexMatch(g libkb.ProofContext, ins *jsonw.Wrapper, state PvlScriptState) (PvlScriptState, libkb.ProofError) {
...
func pvlStepAssertFindBase64(g libkb.ProofContext, ins *jsonw.Wrapper, state PvlScriptState) (PvlScriptState, libkb.ProofError) {
...
func pvlStepWhitespaceNormalize(g libkb.ProofContext, ins *jsonw.Wrapper, state PvlScriptState) (PvlScriptState, libkb.ProofError) {
	state.ActiveString = libkb.WhitespaceNormalize(state.ActiveString)
	return state, nil
}

func pvlStepRegexCapture(g libkb.ProofContext, ins *jsonw.Wrapper, state PvlScriptState) (PvlScriptState, libkb.ProofError) {
...
func pvlStepFetch(g libkb.ProofContext, ins *jsonw.Wrapper, state PvlScriptState) (PvlScriptState, libkb.ProofError) {
	fetchType, err := ins.AtKey(PvlFetch).GetString()
	if err != nil {
		return state, libkb.NewProofError(keybase1.ProofStatus_INVALID_PVL,
			"Could not get fetch type")
...
func pvlStepSelectorJSON(g libkb.ProofContext, ins *jsonw.Wrapper, state PvlScriptState) (PvlScriptState, libkb.ProofError) {
...
func pvlStepSelectorCSS(g libkb.ProofContext, ins *jsonw.Wrapper, state PvlScriptState) (PvlScriptState, libkb.ProofError) {
...
func pvlStepTransformURL(g libkb.ProofContext, ins *jsonw.Wrapper, state PvlScriptState) (PvlScriptState, libkb.ProofError) {
...
func pvlRunCSSSelectorInner(g libkb.ProofContext, html *goquery.Selection, selectors *jsonw.Wrapper) (*goquery.Selection, libkb.ProofError) {
...
func pvlRunSelectorJSONInner(g libkb.ProofContext, state PvlScriptState, object *jsonw.Wrapper, selectors []*jsonw.Wrapper) ([]string, libkb.ProofError) {
...
func pvlInterpretRegex(g libkb.ProofContext, template string, state PvlScriptState) (*regexp.Regexp, libkb.ProofError) {
...
func pvlCustomError(g libkb.ProofContext, ins *jsonw.Wrapper, state PvlScriptState, err1 libkb.ProofError) (libkb.ProofError, bool) {
	if err1 == nil {
		return err1, false
	}
